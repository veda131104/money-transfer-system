...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> login(@Valid @RequestBody LoginRequest request) {
        ...
        LoginResponse resp = new LoginResponse(user.getId(), user.getEmail(), user.getName(), token);
        resp.setRememberToken(user.getRememberToken());
    ...
    public ResponseEntity<LoginResponse> verifyToken(@RequestParam String token) {
        ...
        LoginResponse resp = new LoginResponse(user.getId(), user.getEmail(), user.getName(), jwtToken);
        return ResponseEntity.ok(resp);
    }
